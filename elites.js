...
export function updateElites(room,dt,bullets,player){
 ...
 for(const e of room.enemies){if(!e.elite||e.hp<=0||e.spawnGrace>0||e.frozen>0||e.opening>0)continue;e.eliteCooldown=(e.eliteCooldown||0)-dt;
...
export function eliteDeath(e,room){if(!e.elite)return false;if(e.elite==='explosive')(room.blasts??=[]).push({x:e.x,y:e.y,r:85,time:1,damage:18});return true;}
